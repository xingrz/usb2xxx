...
export function getGpio(lib: LibraryInstance<typeof GPIO>, handle: number) {
  return {
    ...
    async read(pinMask: number): Promise<number> {
      const pinValue = new IntArrayType(1);
